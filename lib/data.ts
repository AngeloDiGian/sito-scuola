...
export const edCivica = [
  ...
  {
    titolo: "Internet Crimes - Relazione",
    sottotitolo:
      "Relazione sui crimini informatici: analisi, cause e strategie di prevenzione.",
    descrizione:
      "I crimini informatici, o cybercrimes, includono attività illegali che sfruttano internet, come frodi, phishing, attacchi informatici e furto di dati. Questi crimini possono essere classificati in cinque categorie principali: frodi finanziarie, cyberbullismo e reati contro la persona, attacchi informatici, sfruttamento online e violazione della proprietà intellettuale. \nLe cause principali includono l'anonimato su internet, la facilità di accesso e la scala globale, e le vulnerabilità tecnologiche. Gli impatti negativi spaziano dai danni economici e sociali alla compromissione della sicurezza digitale. \nPer contrastare i cybercrimes, sono essenziali leggi rigorose, come la Convenzione di Budapest, l'educazione e la sensibilizzazione degli utenti, e l'adozione di tecnologie di sicurezza avanzate come firewall, crittografia e software antimalware. Combattere efficacemente questi crimini richiede collaborazione internazionale e un impegno costante nella promozione della sicurezza informatica.",
